...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="SAFARİ YAZILIM Kurumsal Script v2.1" />
    ...
    <link href="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
    <link href="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    ...
    <link type="text/css" href="<?= SITE_URL ?>/public/orakuploader/orakuploader.css" rel="stylesheet" />
    <!-- CUSTOM STYLE -->
    <style>
            ...
            <div id="kt_app_header" class="app-header">
                ...
                <div class="app-container container-fluid d-flex align-items-stretch flex-stack" id="kt_app_header_container">
                    ...
                    <div class="d-flex align-items-center d-block d-lg-none ms-n3" title="Show sidebar menu">
                        ...
                        <a href="index.html">
                            <img alt="Logo" src="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/media/logos/demo38-small.svg" class="h-30px" />
                        </a>
                    ...
                    <div class="app-navbar flex-lg-grow-1" id="kt_app_header_navbar">
                                    ...
                                    <div data-kt-search-element="wrapper">
                                        ...
                                        <div class="" data-kt-search-element="main">
                                            <div class="d-flex flex-stack fw-semibold mb-4">
                                                <span class="text-muted fs-6 me-2">Arama Sonuçları</span>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="app-navbar-item ms-1 ms-md-3" id="kt_header_user_menu_toggle">
                            <div class="cursor-pointer symbol symbol-circle symbol-35px symbol-md-45px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                                <img src="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/media/avatars/300-2.jpg" alt="user" />
                            </div>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                    <div class="menu-content d-flex align-items-center px-3">
                                        <div class="symbol symbol-50px me-5">
                                            <img alt="Logo" src="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/media/avatars/300-2.jpg" />
                                        </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="account/overview.html" class="menu-link px-5">Geçmiş İşlemlerim</a>
                                </div>
                                <div class="menu-item px-5">
                                    <a href="account/overview.html" class="menu-link px-5">Bilgilerim</a>
                                </div>
                                <div class="separator my-2"></div>
                                ...
                                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                                    ...
                                    <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                        <?php
                                        $langs = $this->utils->LangList();
                                        foreach ($langs as $lang) :
                                        ?>
                                            <div class="menu-item px-3">
                                                <a href="<?= SITE_URL ?>/lang/change/<?= $lang['Guid'] ?>/?p=<?= htmlspecialchars($_REQUEST['url'], ENT_QUOTES) ?>" class="menu-link d-flex px-5 active">
                                                    <span class="symbol symbol-20px me-4">
                                                        <img class="rounded-1" src="<?= SITE_URL  . $lang['Img'] ?>" alt="" />
                                                    </span><?= $lang['Title'] ?></a>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                ...
                                <div class="menu-item px-5">
                                    <a href="<?= SITE_URL . '/admincp/logout' ?>" class="menu-link px-5">Çıkış Yap</a>
                                </div>
                ...
                <div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="250px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
                    <div class="app-sidebar-header d-flex flex-stack d-none d-lg-flex pt-8 pb-2" id="kt_app_sidebar_header">
                        ...
                        <a href="index.html" class="app-sidebar-logo">
                            <img alt="Logo" src="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/media/logos/demo38.svg" class="h-25px d-none d-sm-inline app-sidebar-logo-default theme-light-show" />
                            <img alt="Logo" src="<?= SITE_URL . '/' . THEME_PATH . 'admin/assets' ?>/media/logos/demo38-dark.svg" class="h-20px h-lg-25px theme-dark-show" />
                        </a>
                    ...
                    <div class="app-sidebar-navs flex-column-fluid py-6" id="kt_app_sidebar_navs">
                        <div id="kt_app_sidebar_navs_wrappers" class="app-sidebar-wrapper hover-scroll-y my-2" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_header" data-kt-scroll-wrappers="#kt_app_sidebar_navs" data-kt-scroll-offset="5px">
                            <div id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false" class="app-sidebar-menu-primary menu menu-column menu-rounded menu-sub-indention menu-state-bullet-primary">
                                <?php
                                function menuHeader($title, $icon)
                                {
                                    return '<div class="menu-item mt-3 mb-0">
                                    <div class="menu-heading text-uppercase fs-7 fw-bold"><span class="m-1 p-1"><i class="' . $icon . ' fw-bold fs-1"></i></span>' . $title . '</div>
                                    <div class="app-sidebar-separator separator mb-0"></div></div>';
                                }

                                function menuOne($title, $href, $target, $icon, $active = null, $params = null)
                                {
                                    if ($active == $params['page']) {
                                        $active = 'active';
                                    } else {
                                        $active = '';
                                    }
                                    return '<div data-kt-menu-trigger="click" class="menu-item menu-accordion pt-0"><div class="menu-item ">
                                            <a class="menu-link ' . $active . '" href="'  . $href . '" target="' . $target . '">
                                                <span class="menu-icon">
                                                    <i class="' . $icon . ' fw-bold fs-2"></i>
                                                </span>
                                ...
                                $menus = $this->utils->getMenu();
                                foreach ($menus as $menu) {
                                    if ($menu['isHead']) {
                                        echo menuHeader($menu['text'], $menu['icon']);
                                        if (isset($menu['children'])) {
                                            foreach ($menu['children'] as $child) {
                                                echo menuOne($child['text'], $child['href'], $child['target'], $child['icon'], $child['active'], $params);
                                            }
                                        }
                                    } else {
                                        echo menuOne($menu['text'], $menu['href'], $menu['target'], $menu['icon'], $menu['active'], $params);
                                    }
                                }
                                ?>
